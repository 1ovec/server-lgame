...
public class ThreeDESCoder {
    private static final Logger log = LoggerFactory.getLogger(ThreeDESCoder.class);
    ...
    private static ThreeDESCoder threeDES;
...
//    private static final String DES_KEY = "立佰趣收单大优惠";
    ...
    public static synchronized ThreeDESCoder getInstance() {
        if (threeDES == null) {
            threeDES = new ThreeDESCoder();
        }
        return threeDES;
    }
