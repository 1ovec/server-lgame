...
public class DESCoder {
    ...
    private static final String DES_KEY = "slgamexh";
    ...
    private static class DESCoderHolder {
        public static final DESCoder instance = new DESCoder();
    }
    
    public static DESCoder getInstance() {
        return DESCoderHolder.instance;
    }
    ...
    public static void main(String[] args) {
    	String str="623058200000041052237";
    	System.out.println("加密："+DESCoder.getInstance().encrypt(str));
    	System.out.println(DESCoder.getInstance().dencrypt("MD5gBGPN0tM="));
		System.out.println(DESCoder.getInstance().dencrypt("MD5gBGPN0tM="));
	}
}
